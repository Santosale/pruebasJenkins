...
<form:form action="finder/explorer/search.do" modelAttribute="finder">
	...
	<div class="form-group"> 
		...
		<form:input class="form-control" path="minPrice" placeholder="123.45"/>
	...
	<div class="form-group"> 
		...
		<form:input class="form-control" path="maxPrice" placeholder="600.89"/>
		<form:errors class="text-danger" path="maxPrice" />
	</div>
	
	<spring:message code="finder.format.date.input" var="dateFormat"/>
	<div class="form-group"> 
	...
	<input type="button" class="btn btn-danger" name="cancel" value="<spring:message code="trip.cancel" />" onclick="javascript: relativeRedir('finder/explorer/display.do')">
