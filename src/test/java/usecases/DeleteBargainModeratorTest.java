...
@Transactional
public class DeleteBargainModeratorTest extends AbstractTest {
	...
	public void driverDeletePositive() {
		...
		final Object testingData[][] = {
			{
				"moderator1", "bargain1", "", null
			}, {
				"moderator1", "bargain10", "tag4", null
			}, {
				"moderator2", "bargain12", "", null
			},
		};
