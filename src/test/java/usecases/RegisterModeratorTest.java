...
public class RegisterModeratorTest extends AbstractTest {
	...
	public void positiveRegisterModeratorTest() {
		final Object testingData[][] = {
				{
					"admin", "antonio1", "antonio1", "antonio1", true, "Antonio", "Azaña", null, null, "ant@mail.com", "20063918Y", null 
				}, {
					"admin", "alexito", "alexito", "alexito", true, "Alejandro", "Perez", "987532146", null, "a@hotmail.com", "20063918Y", null 
				}, {
					"admin", "carlos", "carlos", "carlos", true, "Carlos", "Sánchez", null, null, "carlosmoderator@mail.com", "20063918Y", null 
				}, {
					"admin", "paquito", "paquito", "paquito", true, "Paco", "Millán", null, "Calle Real Nº6", "paquito@mail.com", "20063918Y", null 
				}, {
					"admin", "manolo", "manolo", "manolo", true, "Manolo", "Guillen", null, "", "manolete@mail.com", "20063918Y", null 
				}, {
					"admin", "pepito", "pepito", "pepito", true, "Pepe", "Escolar", "321456987", "Dirección incorrecta", "pepe@mail.com", "20063918Y", null
				}, {
	...
	public void negativeRegisterModeratorTest() {
		final Object testingData[][] = {
				{
					"company1", "moderator13", "moderator13", "moderator13", true, "Antonio", "Azaña", null, null, "ant@mail.com", "20063918Y", IllegalArgumentException.class 
				}, {
					"sponsor1", "moderator13", "moderator13", "moderator13", true, "Antonio", "Azaña", null, null, "ant@mail.com", "20063918Y", IllegalArgumentException.class 
				}, {
					"user2", "moderator13", "moderator13", "moderator13", true, "Antonio", "Azaña", null, null, "ant@mail.com", "20063918Y", IllegalArgumentException.class 
				}, {
					null, "moderator23", "moderator23", "moderator23", true, "Antonio", "Azaña", "652147893", null, "ant@mail.com", "20063918Y", IllegalArgumentException.class 
				}, {
					"moderator1", "moderator23", "moderator23", "moderator23", true, "Antonio", "Perez", "", "Calle Manager Nº41", "ant@mail.com", "20063918Y", IllegalArgumentException.class 
				}, {
					...
					"admin", "azaña", "azaña", "azaña", true, null, "Azaña", "664857123", "Calle Inventada", "m@mail.com", "20063918Y", ConstraintViolationException.class 
				}, {
					...
					"admin", "azaña2", "azaña2", "azaña2", true, "", "Azaña", "664857123", "Calle Inventada", "m@mail.com", "20063918Y", ConstraintViolationException.class 
				}, {
					...
					"admin", "marta3", "marta3", "marta3", true, "Marta", "Azaña", "664857123", "Calle Novena", null, "20063918Y", ConstraintViolationException.class 
				}, {
					"admin", "maria", "maria", "maria", true, "María", "Villarín", "664254123", "Inserte dirección", "", "20063918Y", ConstraintViolationException.class 
				}, {
					"admin", "gost", "gostino", "gostino", true, "Gostin", "Perez", "", "Calle Moderator Nº41", "gostin@mail.com", "20063918Y", ConstraintViolationException.class 
				}, {
					"admin", "administratoradministratoradministrator", "admin", "admin", true, "Gostin", "Perez", "", "Calle Moderator Nº41", "gostin@mail.com", "20063918Y", ConstraintViolationException.class 
				}, {
