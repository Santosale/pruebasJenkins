...
@Transactional
public class ListSubscriptionTest extends AbstractTest {
	...
	public void testFindAll() {
		final Object testingData[][] = {
			{
				"user", "user1", "findAll", false, null, null, 4, null, null, null
			}, {
				"moderator", "moderator1", "findAll", false, null, null, 4, null, null, null
			}, {
				"admin", "admin", "findAll", false, null, null, 4, null, null, null
			}, {
				"company", "company1", "findAll", false, null, null, 4, null, null, null
			}, {
				"sponsor", "sponsor1", "findAll", false, null, null, 4, null, null, null
			}, {
				null, null, "findAll", false, null, null, 4, null, null, null
			}
		};
	...
	protected void template(final String user, final String username, final String method, final boolean falseId, final String bean, final Integer page, final Integer size, final Integer tam, final Integer numPages, final Class<?> expected) {
		...
		try {
			...
			if (method.equals("findAll"))
				subscriptions = this.subscriptionService.findAll(); //Cogemos todos las suscripciones usando el findAll

			Assert.isTrue(subscriptions.size() == size); //Se compara el tamaño con el esperado
